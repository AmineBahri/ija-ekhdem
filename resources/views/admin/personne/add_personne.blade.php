  ...
  <div class="content-wrapper">
   ...
   @endif
    ...
    <section class="content">
      ...
      <form  class="col-sm-6" action="{{url('add-personnes')}}" method="post" enctype="multipart/form-data">
                @csrf
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" name="nom_societe" class="form-control" placeholder="Enter le prenom"  id="nom_societe" >
          </div>
          <div class="form-group">
 ...
 <div class="form-group">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" name="domaine" class="form-control" placeholder="domaine"  id="domaine" >
          </div>
