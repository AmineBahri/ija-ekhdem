			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-feather-folder"></i> Détails de l'offre</h3>
						</div>
						@if ($errors->any())
                        ...
                        @endif
                         <form method="post" action="/update/{{$offre->id}}">
                         	@csrf
							...
							<div class="row">
								<div class="col-xl-4">
									<div class="submit-field">
										<h5>Titre d'offre</h5>
										<input type="text" class="with-border" name="titre_offre" value="{{$offre->titre_offre}}">
									</div>
								</div>
								<div class="col-xl-4">
									<div class="submit-field">
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<select name="equipe"class="selectpicker with-border" title="Sélectionner l'équipe de travail">
											@foreach($equipes as $equipe)
											@if ($offre->equipe_id == $equipe->id)
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<select name="categorie_offre"class="selectpicker with-border" title="Selectionner catégorie">
										@foreach($category as $item)
										 @if ($offre->categories_id == $item->id)
									...
									<div class="submit-field">
										...
										<div class="input-with-icon">
											<div id="autocomplete-container">
												<input name="emplacement" class="with-border" type="text" value="{{$offre->emplacement}}" placeholder="L'emplacement">
											</div>
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<div class="row">
											<div class="col-xl-6">
												<div class="input-with-icon">
													<input class="with-border" name="salaire_min" type="text" placeholder="Min" value="{{$offre->salaire_min}}">
													<i class="currency">DT</i>
												</div>
											</div>
											<div class="col-xl-6">
												<div class="input-with-icon">
													<input class="with-border" name="salaire_max" type="text" value="{{$offre->salaire_max}}" placeholder="Max">
													<i class="currency">DT</i>
												</div>
											</div>
										</div>
									...
									<div class="submit-field">
										...
										<div class="keywords-container">
											<div class="keyword-input-container">
												<input type="text" name="nombre_poste"class="keyword-input with-border" value="{{$offre->nombre_poste}}" placeholder="e.g. job title, responsibilites"/>
											</div>
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<div class="keywords-container">
											<div class="keyword-input-container">
												<input type="text" name="durée" class="keyword-input with-border" value="{{$offre->durée}}" placeholder="e.g. job title, responsibilites"/>
								...
								<div class="col-xl-4">
									<div class="submit-field">
										...
										<div class="keywords-container">
											<div class="keyword-input-container">
												<input type="date" value="{{$offre->date_publication}}" name="date_publication" class="keyword-input with-border"/>
								...
								<div class="col-xl-12">
								 <div class="submit-field">
								  <h5>Description de l'offre</h5>
									<textarea cols="30" rows="5" value="{{$offre->description_offre}}" name="description_offre" class="with-border">{{$offre->description_offre}}</textarea>
									</div>
								</div>
								<div class="col-xl-12">
				                <input type="submit" value="Editer offre">
				                </div>
				            </div>
						</div>
					</div>
