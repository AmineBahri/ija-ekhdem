...
<div class="container">
	<div class="row">
		<div class="col-xl-5 offset-xl-3">
			...
			<form method="post" action="{{url('update-psw-personne')}}" >
                  @csrf     
					...
					<div class="input-with-icon-left" title="Should be at least 8 characters long" data-tippy-placement="bottom">
							...
							<input type="password" class="input-text with-border" name="password" id="password-register" placeholder="Nouveau mot de passe"/>
						</div>
					<div class="input-with-icon-left" title="Should be at least 8 characters long" data-tippy-placement="bottom">
							<i class="icon-material-outline-lock"></i>
							<input type="password" class="input-text with-border" name="pswcnf" id="password-register" placeholder="Confirmer le nouveau mot de passe"/>
						</div>
				     <input type="submit" class="inputButton" value="initialiser mot de passe">
				</form>
