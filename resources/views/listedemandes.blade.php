                        ...
                        <table>
                        	...
                        	<tbody>
                        		...
                        		<tr>
                        		    ...
                        		    <td>
                        		    <a href="/accept/{{ $item->id }}/{{$id}}"><i class="fa fa-info"></i></a>
      	                            <a href="/refuse/{{ $item->id }}/{{$id}}" onclick = "return confirmDialog();"><i class="fa fa-trash"></i></a>
      	                        </td>
                        		</tr>
                        		@endforeach
                        	</tbody>
...
<script>  
  ...
  {
  var x=confirm("Vous etes sur de supprimer la demande ?")
  if (x) 
  {
    return true;
  } else 
