				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
                       ...
                       @if ($errors->any())
                        ...
                        @endif
<form action="{{url('updatepers')}}" method="post">
	@csrf
<!-- Dashboard Box -->
<div class="col-xl-12">
				...
				<div class="col">
					...
					<div class="col-xl-6">
						...
						<div class="col-xl-6">
							<div class="submit-field">
								<h5>Telephone</h5>
								<input  class="with-border" name="telephone" type="tel" value="{{$infos->telephone}}">
							</div>
						</div>
						...
						<div class="col-xl-6">
							<div class="submit-field">
								<h5>Adresse</h5>
								<input type="text" class="with-border" name="adresse" value="{{$infos->adresse}}">
							</div>
						</div>
					</div>
				</div>
	...
	<div class="col-xl-12">
			...
			<a href="/deletepers/{{ $infos->id }}" class="button ripple-effect big margin-top-30" onclick = "return confirmDialog();">Supprimer mon compte</a>
